...
const docTemplate = `{
    ...
    "paths": {
        ...
        "/passkeys": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "Passkey payload",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.AddPasskeyRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.UpdatePasskeyStatusRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "http.UpdatePasskeyStatusRequest": {
            "type": "object",
            "properties": {
                "enabled": {
                    "type": "boolean",
